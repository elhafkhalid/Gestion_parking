...
@section('content')
    <div class="min-h-screen w-full flex flex-col lg:flex-row-reverse font-sans antialiased bg-slate-50">
        ...
        <div class="relative w-full lg:w-[40%] h-80 lg:h-screen lg:sticky lg:top-0 bg-indigo-900 overflow-hidden">
            ...
            {{-- Gradient amélioré pour image à droite --}}
                            ...
                            <div class="space-y-2 max-h-[400px] overflow-y-auto">
                                @foreach ($parkings as $parking)
                                    ...
                                    <a href="{{ route('visiteur.dashboard', ['parking' => $parking->id]) }}"
                                        class="group block p-4 rounded-xl transition-all 
                                        {{ $isSelected ? 'bg-indigo-50 border-2 border-indigo-600' : 'bg-slate-50 border-2 border-transparent hover:border-slate-200' }}">
                    ...
                    <main class="xl:col-span-8">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                                        ...
                                        <div class="text-center md:text-left">
                                            ...
                                            <p class="text-slate-400 mt-4 font-medium">
                                        ...
                                        <div
                                            ...
                                            <p class="text-6xl font-black mt-2 leading-none">
                                                {{ $availablePlaces }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-8 divide-x divide-slate-800">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-3xl font-black">
                                                {{ $selectedParking->price_car }}€
                                                <span class="text-sm text-slate-400">/h</span>
                                            </p>
                                            <p class="text-[10px] uppercase text-slate-500 mt-2">
                                                Véhicule
                                            </p>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-3xl font-black">
                                                {{ $selectedParking->price_motorcycle }}€
                                                <span class="text-sm text-slate-400">/h</span>
                                            </p>
                                            <p class="text-[10px] uppercase text-slate-500 mt-2">
                                                Deux-roues
                        ...
                        @else
                            ...
                            <div
                                ...
                                <p class="text-5xl mb-6 opacity-30">🅿️</p>
                                <h3 class="text-xl font-black text-slate-400 uppercase">
                                    En attente de sélection
                                </h3>
                                <p class="text-slate-400 mt-2 text-sm max-w-xs">
                                    Choisissez un emplacement pour voir les données.
                                </p>
                            </div>
                        @endif
                    </main>
